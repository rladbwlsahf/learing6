...
public class EqualExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("origin : "+ origin[0]);		//
		System.out.println("cloned1 : " + cloned1[0]);	//서로 같음.{1,2}	데이터는 공유해서 같다
		
		System.out.println("1차 배열 항목값을 비교 : " + Arrays.equals(origin, cloned1));
		//	origin이 가르키는 주소 기반에서//	origin[0] == cloned1[0]
		System.out.println("중첩 배열 항목값을 비교 : " + Arrays.deepEquals(origin, cloned1));
		//	origin이 가르키는 내용 기반에서//	배열 안에 있는 데이터를 비교하는 기능.
